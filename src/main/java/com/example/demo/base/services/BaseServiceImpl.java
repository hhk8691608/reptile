package com.example.demo.base.services;

import java.util.List;

import com.example.demo.base.mappers.BaseMapper;
...
public abstract class BaseServiceImpl<T, PK, S extends BaseMapper<T, PK>> {
	...
	public S getDao() {
		if (dao != null) {
			...
			dao = (S) SpringTool.getBean(
					((Class) ((ParameterizedType) this.getClass().getGenericSuperclass()).getActualTypeArguments()[2]));
			return dao;
		}
	}
